 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output0[i] = FAUSTFLOAT((fTemp1 + (0.707106769f * (fRec0[0] * (float(AnalogDelay1(float((fRec1[0] + (fTemp2 * fTemp5))), float(fTemp0))) + fTemp0)))));
			fRec8[0] = (fSlow8 + (fConst1 * fRec8[1]));
			output1[i] = FAUSTFLOAT((fTemp1 + (0.707106769f * (fRec0[0] * (float(AnalogDelay2(float((fRec1[0] + (fTemp2 * (((1.0f - fRec8[0]) * fTemp5) + (fRec8[0] * (1.0f - fTemp5)))))), float(fTemp0))) + fTemp0)))));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
